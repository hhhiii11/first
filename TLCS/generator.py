...
class TrafficGenerator:
    ...
    def generate_routefile(self, seed):
        ...
        with open("intersection/episode_routes.rou.xml", "w") as routes:
            ...
            <vType accel="1.0" decel="4.5" id="emergency_car" length="7.0" minGap="2.5" maxSpeed="25" sigma="0.6" />
            ...
            for car_counter, step in enumerate(car_gen_steps):
                standard_or_emergency = np.random.uniform()
                if standard_or_emergency < 0.01:
                    vehicle_type = "emergency_car"
                else:
